...
export default function Home() {
  ...
  return (
    <div className="space-y-8 relative pb-20">
      ...
      {/* Header Section */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:pr-12">
        <div className="w-full md:w-auto text-center md:text-left">
          ...
          <p className="text-gray-600 mt-2 text-base md:text-lg lg:text-xl">
            {user ? "Your digital empire is growing." : "The exclusive network for elite professionals."}
          </p>
        </div>
        
        <div className="flex items-center justify-center md:justify-end w-full md:w-auto gap-3 md:gap-4">
            {user && (
              <>
                <div className="hidden sm:flex items-center gap-3 glass-panel px-4 py-2 rounded-full border border-[var(--color-supreme-gold)]/20 shadow-[0_0_15px_rgba(184,134,11,0.1)] bg-white/50">
                    <TrendingUp className="text-[var(--color-supreme-gold)] w-5 h-5" />
                    <span className="text-[var(--color-supreme-gold)] font-medium">+12% Growth</span>
                </div>
                ...
                <button 
                    ...
                    className={clsx(
                        "p-2 rounded-xl shadow-md transition-all border flex items-center gap-2 px-4 py-2.5 font-bold text-sm",
                        isEditing 
                            ? "bg-[var(--color-supreme-gold)] text-white border-[var(--color-supreme-gold)]" 
                            : "bg-white border-gray-200 text-gray-500 hover:text-[var(--color-supreme-text)]"
                    )}
                >
                    {isEditing ? (
                        <>
                            <LayoutDashboard className="w-4 h-4" /> Done
                        </>
                    ) : (
                        <>
