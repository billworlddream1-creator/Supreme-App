...
import { Upload, Video, Scissors, Music, Wand2, AlertCircle, CheckCircle2, X, FileText, Image as ImageIcon, Calendar, Sparkles, LayoutGrid, Clock, Hash, Languages, Globe, ChevronDown, Activity, Gauge, ShieldAlert, ShieldCheck, Fingerprint, History } from 'lucide-react';
        ...
        {activeTab === 'post' && (
          <div className="space-y-6">
                      ...
                      {LANGUAGES.map((lang) => (
                        <button
                          ...
                          className={clsx(
                            ...
                            targetLanguage === lang ? "text-purple-600 font-bold bg-purple-50" : "text-gray-600"
                          )}
                        >
                          {lang}
                        </button>
            ...
            <div className="flex justify-end gap-4 pt-6 border-t border-gray-100">
              ...
              <button className="px-8 py-3 bg-[var(--color-supreme-gold)] text-white font-bold rounded-xl hover:bg-[var(--color-supreme-gold-light)] transition-colors shadow-md">
